...
LiOpt = {
    "LiRepeat": 10,  # how many times shall we repeat li optimization to ensure finding feasible solution
    "LiInit": 1,  # number of previous time steps used for initialization
}

testing_dataset_start = 10324
representative_weeks = [2]
# representative_weeks = [2, 4, 7, 9, 10, 11, 14]


opt_steps = {
    "math_opt": [
        testing_dataset_start + (representative_week - 1) * 24 * 7
        for representative_week in representative_weeks
    ]
}
