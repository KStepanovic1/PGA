...
from src.optimizers.constraint_opt.dhn_nn.param import *
from src.optimizers.constraint_opt.dhn_nn.config_experiments import experiments_learning
from src.optimizers.constraint_opt.dhn_nn.prediction import multi_step_prediction, save_loss
from src.optimizers.constraint_opt.dhn_nn.state import StatePLNN, StateICNN, StateMonotonicICNN
from src.optimizers.constraint_opt.dhn_nn.output import OutputPLNN, OutputICNN, OutputMonotonicICNN

if __name__ == "__main__":
    experiments_type: dict = experiments_learning["predictions"]
    ...
    layer_sizes = [[1]]
    time_delay: int = time_delay[str(PipePreset1["Length"])]  # number of previous actions
    time_delay_q: int = time_delay_q[str(PipePreset1["Length"])]  # number of previous heat demands
